 ...
 * ==========================================================
 *
 * Library of static html components for the admin area. This file must not be executed directly. © 2017-2026 board.support. All rights reserved.
 *
 */
        ...
        <div class="sb-top-bar">
            ...
            <div>
                ...
                if (defined('SB_WHATSAPP') && sb_whatsapp_active()) {
                    echo '<a data-value="whatsapp" class="sb-btn-icon" data-sb-tooltip="' . sb_('Send a WhatsApp message template') . '"><i class="sb-icon-social-wa"></i></a>' . (sb_get_multi_setting('whatsapp-call', 'whatsapp-call-disable') != 'all' ? '<a data-value="whatsapp-call" class="sb-btn-icon" data-sb-tooltip="' . sb_('WhatsApp call') . '"><i class="sb-icon-call"></i></a>' : '');
                }
...
function sb_component_admin() {
    ...
    if ($admin_colors[0]) {
        ...
        $css .= '.sb-setting input:focus, .sb-setting select:focus, .sb-setting textarea:focus, .sb-setting input:focus, .sb-setting select:focus, .sb-setting textarea:focus,.sb-setting.sb-type-upload-image .image:hover,
                 .sb-setting [data-type="upload-image"] .image:hover, .sb-setting.sb-type-upload-image .image:hover, .sb-setting [data-type="upload-image"] .image:hover,.sb-input > input:focus, .sb-input > input.sb-focus,
                 .sb-input > select:focus, .sb-input > select.sb-focus, .sb-input > textarea:focus, .sb-input > textarea.sb-focus,.sb-search-btn > input,.sb-search-btn > input:focus { border-color: ' . $admin_colors[0] . '; box-shadow: 0 0 5px rgb(108 108 108 / 20%);}';
        $css .= '.sb-menu-wide ul li.sb-active, .sb-menu-wide ul li:hover, .sb-tab > .sb-nav > ul li.sb-active, .sb-tab > .sb-nav > ul li:hover,.sb-admin > .sb-header > .sb-admin-nav > div > a:hover,
                 .sb-admin > .sb-header > .sb-admin-nav > div > a.sb-active,.sb-setting input[type="checkbox"]:checked:before, .sb-setting input[type="checkbox"]:checked:before,.sb-language-switcher > i:hover,
                 ...
                 .sb-board .sb-conversation .sb-list > div .sb-menu-btn:hover,.sb-select:not(.sb-disabled) p:hover,#sb-settings.sb-active,.sb-custom-select span:hover { color: ' . $admin_colors[0] . '; }';
        $css .= '.sb-area-settings .sb-tab  .daterangepicker td.active, .daterangepicker td.active:hover, .daterangepicker .ranges li.active,div ul.sb-menu li:hover,div.sb-select.sb-select-colors > p:hover,
                 .sb-board > .sb-admin-list .sb-scroll-area li > .sb-notification-counter,.sb-btn:hover, .sb-btn:active, a.sb-btn:hover, a.sb-btn:active,.sb-custom-select span:hover,
                 .sb-board > .sb-admin-list > .sb-scroll-area li.sb-active:before { background-color: ' . $admin_colors[0] . '; }';
        $css .= '.sb-board > .sb-admin-list.sb-departments-show li.sb-active:before { background-color: ' . $admin_colors[0] . ' !important;}';
        $css .= '.sb-tags-cnt > span:hover,.sb-btn-icon:hover { border-color: ' . $admin_colors[0] . '; color: ' . $admin_colors[0] . '; }';
        ...
        $css .= '.sb-board .sb-user-details,.sb-admin > .sb-header,.sb-select.sb-select-colors > p:not([data-value]),.sb-table tr:hover td,.sb-board .sb-user-details .sb-user-conversations li:hover,
                 .sb-board .sb-user-details .sb-user-conversations li.sb-active, .sb-select.sb-select-colors > p[data-value=""], .sb-select.sb-select-colors > p[data-value="-1"] {background-color: #f5f5f5  }';
        ...
        $css .= '.sb-admin .sb-top-bar > div:first-child > ul::-webkit-scrollbar-thumb:hover,.sb-area-settings > .sb-tab > .sb-nav::-webkit-scrollbar-thumb:hover, .sb-area-reports > .sb-tab > .sb-nav::-webkit-scrollbar-thumb:hover,
                 .sb-dialog-box pre::-webkit-scrollbar-thumb:hover, .sb-horizontal-scroll::-webkit-scrollbar-thumb:hover,.sb-scroll-area::-webkit-scrollbar-thumb:hover { background:' . $admin_colors[0] . '; }';
                ...
                <div class="sb-admin-nav-right sb-menu-mobile">
                    ...
                    <div class="sb-desktop">
                        ...
                        if ($active_areas['settings']) {
                            echo '<a id="sb-settings"><i class="sb-icon-settings"></i></a>';
                        }
                        if ($is_admin) {
                            sb_docs_link();
                        }
                    ...
                    <div class="sb-mobile">
                        <?php
                        if ($active_areas['settings']) {
                            echo '<a id="sb-settings">' . sb_('Settings') . '</a>';
                        }
                ...
                <div class="sb-active sb-area-conversations">
                    <div class="sb-board">
                        ...
                        <div class="sb-conversation">
                            ...
                            <audio id="sb-audio-call" autoplay></audio>
                        </div>
                        <div class="sb-user-details">
                            ...
                            <div class="sb-scroll-area">
                                ...
                                <div class="sb-panel-conversation-details<?php echo $collapse ?>"></div>
                                <?php
                                sb_apps_panel();
                                if (sb_get_multi_setting('google-calendar', 'google-calendar-active') || sb_get_multi_setting('tidycal', 'tidycal-active')) {
                                    $is_tidycal = sb_get_multi_setting('tidycal', 'tidycal-active');
                                    echo ' <div class="sb-panel-details sb-panel-calendar ' . ($is_tidycal ? 'sb-tidycal' : 'sb-google-calendar') . $collapse . ' sb-hide"><i class="sb-icon-plus"></i><h3><a href="' . ($is_tidycal ? 'https://tidycal.com/dashboard' : 'https://calendar.google.com/calendar') . '" target="_blank"><img src="' . SB_URL . '/media/apps/' . ($is_tidycal ? 'tidycal' : 'google-calendar') . '.svg" /></a>' . ($is_tidycal ? 'TidyCal' : 'Google Calendar') . '</h3><div class="sb-list-links"></div></div>';
                                }
                    ...
                    <i class="sb-btn-collapse sb-icon-sidebar"></i>
                </div>
                            ...
                            <div>
                                ...
                                <div class="sb-menu-mobile">
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                        <li>
                                            <a data-value="merge_users" class="sb-btn-icon" data-sb-tooltip="<?php sb_e('Merge users') ?>" style="display: none;">
                                                <i class="sb-icon-shuffle"></i>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <?php if ($active_areas['reports']) { ?>
                    <div class="sb-area-reports sb-loading">
                        <div class="sb-top-bar">
                            ...
                            <div>
                                <div class="sb-select sb-select-reports">
                                    <p data-value="conversations">
                                        <?php sb_e('Conversations') ?><span></span>
                                    </p>
                                    <ul>
                                        <li data-value="conversations" class="sb-active">
                                            <?php sb_e('Conversations') ?>
                                        </li>
                                        <?php 
                                        if (sb_is_chatbot_active()) {
                                            echo'<li data-value="chatbot">' . sb_('Chatbot') . '</li>';
                                        }
                                        ?>
                                        <li data-value="users">
                                            <?php sb_e('Users') ?>
                                        </li>
                                        <li data-value="agents">
                                            <?php sb_e('Agents') ?>
                                        </li>
                                         <li data-value="articles">
                                            <?php sb_e('Articles') ?>
                                        </li>
                                        <li data-value="messages">
                                            <?php sb_e('Messages') ?>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="sb-tab">
                            <div class="sb-nav sb-scroll-area">
                                ...
                                <ul>
                                    ...
                                    $code = '';
                                    foreach ($apps as $app) {
                                        if (defined($app[0]) && (!$is_cloud || in_array($app[1], $cloud_active_apps))) {
                                            $code .= '<li id="tab-' . $app[1] . '">' . sb_($app[2]) . '</li>';
                                        }
                                    }
                                    $code .= '<li id="tab-apps">' . ($disable_translations ? 'Apps' : sb_('Apps')) . '</li>';
                                    foreach ($custom_apps as $custom_app) {
                                        $code .= '<li id="tab-' . $custom_app[0] . '">' . $custom_app[1] . '</li>';
                                    }
                                    echo $code;
                                    ?>
                                    <li id="tab-articles">
                            ...
                            <div class="sb-content sb-scroll-area">
                                ...
                                <?php
                                if (!empty($custom_apps)) {
                                    $code = '';
                                    foreach ($custom_apps as $custom_app) {
                                        $code .= '<div>' . sb_populate_app_settings($custom_app[0]) . '</div>';
                                    }
                                    echo $code;
                                }
                                ?>
...
function sb_conversations_filter($cloud_active_apps) {
    ...
    echo $code .= '<div id="sb-close-filters-btn"><i class="sb-icon-close"></i></div></div></div>';
}
