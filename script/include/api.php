 ...
 * ==========================================================
 *
 * API. This file listens the POST queries and return the result. © 2017-2026 board.support. All rights reserved.
 *
 */
...
function sb_process_api() {
    $function_name = sb_sanatize_string($_POST['function'], true);
    $functions = [
        ...
        'init-articles' => [],
        'login-link' => ['email', 'url'],
        'merge-users' => ['user_id_1', 'user_id_2'],
        'calendar-get-available-slots' => ['date'],
        'calendar-create-booking' => ['start_date', 'user_id'],
        'calendar-cancel-booking' => ['booking_id'],
        'add-saved-reply' => ['name', 'text'],
        'get-agent' => ['agent_id'],
        'update-conversation-extra' => ['conversation_id'],
        'close-message' => ['conversation_id'],
        'rating-message' => ['conversation_id'],
        'get-rich-message' => ['name'],
        'create-email' => ['recipient_id', 'sender_name', 'sender_profile_image', 'message'],
        'human-takeover' => ['conversation_id'],
        'subscribe-email' => ['email'],
        'agents-online' => [],
        'reports-export' => ['name'],
        'update-note' => ['conversation_id', 'user_id', 'note_id', 'message'],
        'messenger-get-posts' => [],
        'messenger-send-comment' => ['comment_id', 'facebook_page_id', 'message', 'message_id'],
        'whatsapp-get-templates' => [],
        'google-troubleshoot' => [],
        'zendesk-create-ticket' => ['conversation_id'],
        'zendesk-update-ticket' => ['conversation_id'],
        'open-ai-rewrite-message' => ['message'],
        'open-ai-smart-reply' => ['message', 'conversation_id'],
        'open-ai-generate-embeddings' => ['paragraphs'],
        'open-ai-file-training' => ['url'],
        'open-ai-url-training' => ['url'],
        'open-ai-qea-training' => ['questions_answers'],
        'open-ai-articles-training' => [],
        'open-ai-embeddings-delete' => ['sources_to_delete'],
        'open-ai-troubleshoot' => [],
        'open-ai-get-training-files' => [],
        'open-ai-get-qea-training' => [],
        'open-ai-get-information' => [],
        'open-ai-playground-message' => ['message'],
        'open-ai-flows-save' => ['flows'],
        'open-ai-flows-get' => [],
        'open-ai-send-fallback-message' => ['conversation_id'],
        'open-ai-audio-transcript' => ['url'],
        'audio-to-text' => ['path'],
        'data-scraping' => ['conversation_id', 'prompt_id'],
        'update-tags' => ['conversation_id', 'tags'],
        'import-users' => ['file_url'],
        'otp' => ['email'],
        'shopify-get-product-link' => ['product_id'],
    ...
    $apps = [
        'SB_WP' => ['wp-sync'],
        'SB_DIALOGFLOW' => ['google-get-token', 'google-translate', 'google-translate-detection-update-user', 'open-ai-curl', 'open-ai-message', 'open-ai-user-expressions'],
    ...
    switch ($function_name) {
        ...
        case 'open-ai-embeddings-delete':
            $json_keys = ['sources_to_delete'];
            break;
        case 'open-ai-qea-training':
            $json_keys = ['questions_answers'];
            break;
        case 'open-ai-generate-embeddings':
            $json_keys = ['paragraphs'];
            break;
